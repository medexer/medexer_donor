              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      CustomTextWidget(
                        text:'Medexer seeks to increase the ease with which hospitals have access to blood and save lives by connecting hospitals directly to blood donors.',
                        size: 12.0.sp,
                      ),
                      CustomTextWidget(
                        text:'You an find and book appointments with blood donation centres by doing the following:\n',
                        size: 12.0.sp,
                      ),
                      CustomTextWidget(
                        text:' 1. Navigate to Menu > Home \n 2. Enter the name of the hospital or donation centre on the search bar. \n 3. Click on the correct result that pops up. \n 4. Make a call or send an SMS to the hospital or donation centre to book an appointment. \n 5. Locate the donation centre by following the map directions.',
                        size: 12.0.sp,
                      ),
                      CustomTextWidget(
                      ...
                      CustomTextWidget(
                          text:'Note: You will have to wait for your KYC to be approved for you to fully use this app.',
                          size: 12.0.sp,
                      ),
                      CustomTextWidget(
                          text:
