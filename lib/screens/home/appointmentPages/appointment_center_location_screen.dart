...
class AppointmentCenterLocationScreen extends StatefulWidget {
  final AppointmentModel appointmentCenter;
  const AppointmentCenterLocationScreen(
      {super.key, required this.appointmentCenter});

  @override
  State<AppointmentCenterLocationScreen> createState() =>
      _AppointmentCenterLocationScreenState();
}

class _AppointmentCenterLocationScreenState
    extends State<AppointmentCenterLocationScreen> {
  ...
  void getPolyPoints() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
        ...
        PointLatLng(widget.appointmentCenter.centerGeoLocation!.lat!,
            widget.appointmentCenter.centerGeoLocation!.lng!));
    ...
    setState(() {
      markers.add(
        Marker(
          ...
          markerId: MarkerId('${widget.appointmentCenter.pkid}'),
          position: LatLng(widget.appointmentCenter.centerGeoLocation!.lat!,
              widget.appointmentCenter.centerGeoLocation!.lng!),
          onTap: () {
            customInfoWindowcontroller.addInfoWindow!(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CustomTextWidget(
                            text:
                                '${widget.appointmentCenter.hospitalInfo!.hospitalName}',
                            size: 14.0.sp,
                          ),
                          CustomTextWidget(
                            text:
                                '${widget.appointmentCenter.hospitalInfo!.location}',
                            size: 10.0.sp,
                          ),
                        ],
                      ),
              ...
              LatLng(widget.appointmentCenter.centerGeoLocation!.lat!,
                  widget.appointmentCenter.centerGeoLocation!.lng!),
            );
          },
        ),
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          backgroundColor: widget.appointmentCenter.isDonated == true
              ? Colors.green.shade600
              : AppStyles.bgPrimary,
          title: CustomTextWidget(
            text:
                '${widget.appointmentCenter.hospitalInfo!.hospitalName} Location',
            size: 12.0.sp,
          ),
        ),
        body: Obx(
                  ...
                  children: [
                    ...
                    GoogleMap(
                      ...
                      initialCameraPosition: CameraPosition(
                          target: LatLng(
                              widget.appointmentCenter.centerGeoLocation!.lat!,
                              widget.appointmentCenter.centerGeoLocation!.lng!),
                          zoom: 13.5),
                      onTap: (Position) {
