...
class CustomAffirmationButton extends StatefulWidget {
  final List items;
  String title;
  String currentItem;
  ...
  @override
  State<CustomAffirmationButton> createState() =>
      _CustomAffirmationButtonState();
}

class _CustomAffirmationButtonState extends State<CustomAffirmationButton> {
  void onTapHandler() {
