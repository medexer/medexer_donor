...
class CustomBloodDonationTimelineButton extends StatefulWidget {
  final List items;
  String currentItem;
  ...
  @override
  State<CustomBloodDonationTimelineButton> createState() =>
      _CustomBloodDonationTimelineButtonState();
}

class _CustomBloodDonationTimelineButtonState
    extends State<CustomBloodDonationTimelineButton> {
  void onTapHandler() {
